...
//		String baseurl = "https://chaldal.com/";
	...
	public void ChangeLocation() throws InterruptedException{
		...
		driver.findElement(By.className("citySelectionLink")).click();
		Thread.sleep(2000);
	...
	public void OrderTesting() throws InterruptedException{
		...
		driver.findElement(By.xpath("//img[@alt='Fresh Vegetables']")).click();
		Thread.sleep(500);
//		driver.findElement(By.xpath("//body/div[@id='page']/div[1]/div[6]/section[1]/div[1]/div[1]/div[1]/div[1]/section[1]/div[2]/div[1]/div[2]/div[1]/section[1]")).click(); 
//		driver.findElement(By.xpath("//body/div[@id='page']/div[1]/div[6]/section[1]/div[1]/div[1]/div[1]/div[1]/section[1]/div[2]/div[1]/div[3]/div[1]/section[1]")).click(); 
		driver.findElement(By.xpath("//body/div[@id='page']/div[1]/div[6]/section[1]/div[1]/div[1]/div[1]/div[1]/section[1]/div[2]/div[1]/div[4]/div[1]/section[1]")).click(); 
		driver.findElement(By.xpath("//body/div[@id='page']/div[1]/div[6]/section[1]/div[1]/div[1]/div[1]/div[1]/section[1]/div[2]/div[1]/div[5]/div[1]/section[1]")).click(); 
